import { GraphQLSchema, GraphQLObjectType, GraphQLString, GraphQLInt, GraphQLFloat, GraphQLList, GraphQLNonNull } from "graphql";
// Product type
...
const QueryType = new GraphQLObjectType({
    ...
    fields: () => ({
        products: {
            ...
            resolve: (_source, _args, context) => context.productsResolver()
        },
        customerOrders: {
            type: new GraphQLList(OrderType),
            description: "Get orders for authenticated customer",
            resolve: (_source, _args, context) => context.ordersResolver()
        }
    })
});
// Create schema
